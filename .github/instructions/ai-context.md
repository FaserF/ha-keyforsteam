# AI Context & Instructions for ha-keyforsteam

## 🧬 Project DNA
**Repository:** `ha-keyforsteam`
**Type:** Home Assistant Custom Integration
**Domain:** `keyforsteam`
**Description:** Track game prices from **KeyForSteam** (AllKeyShop) directly in Home Assistant. Get real-time updates on the lowest prices, best deals, and seller information for your favorite games.
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/keyforsteam/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
