...
def main():
    ...
    run_git(
        ["checkout", "--", "custom_components/keyforsteam/manifest.json"]
    )
    ...
    for f in changed_files:
        if f.startswith("custom_components/keyforsteam/translations/"):
            translation_count += 1
    ...
    body_parts = [
        f"# KeyforSteam {version}  {channel_badge}",
        "",
        prerelease_note,
        "## 📋 What's Changed",
        "",
        ...
        "---",
        "",
        f"*📖 [Documentation](https://faserf.github.io/ha-keyforsteam/)  ·  🐛 [Report an Issue](https://github.com/{repo}/issues/new/choose)  ·  📦 [All Releases](https://github.com/{repo}/releases)*",
    ]
